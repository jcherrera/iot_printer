...
# Print once a day at 8:30am
# Call weather forecast and fortune
def daily():
  GPIO.output(ledPin, GPIO.HIGH)
  subprocess.call(["python", "just_forecast.py"])
  subprocess.call(["python", "reddit_read.py"])
...
while(True):
  ...
  l = time.localtime()
  if dailyFlag == False:
	  if (l.tm_hour == 8 and l.tm_min >= 30):
		  daily()
		  dailyFlag = True
  else:
